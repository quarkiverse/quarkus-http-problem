...
class OpenApiIT {
    ...
    void shouldDeriveApiResponseFromEndpointMethodThrowsDeclaration() {
        getOpenApi()
                ...
                //.body("paths['/openapi/throwing']['post']['responses']['401'].description", equalTo("Unauthorized: request was not successful because it lacks valid authentication credentials for the requested resource"))  // TODO FIXME
